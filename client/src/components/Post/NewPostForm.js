        ...
        const handleVideo = () => {
            ...
            for (let i = 0; i < findLink.length; i++){
                if (findLink[i].includes('https://www.yout') || findLink[i].includes('https://yout')){
                    ...
                    // j'efface les liens youtube de l'impute
                    findLink.splice(i, 1);
                    setMessage(findLink.join(" "));
                    // j'efface une potentiel photo
                    setPostPicture('');
                }
            }
        }
                ...
                <div className="post-form">
                    ...
                    <div className="footer-form">
                        ...
                        <div className="btn-send">
                            {message || postPicture || video.length > 20 ? (
                                <button className="cancel" onClick={(e) => cancelPost(e)}>Annuler message</button>
                            ) : null}
                            <button className="send" onClick={(e) => handlePost(e)}>Envoyer</button>
                        </div>
                    </div>
                </div>
                </>
